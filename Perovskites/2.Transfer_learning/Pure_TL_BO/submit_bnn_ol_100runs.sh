#!/bin/bash
#SBATCH --job-name=bnn_ol_100
#SBATCH --reservation=rental_9427
#SBATCH --cpus-per-task=10
#SBATCH --mem=80G
#SBATCH --gres=gpu:1
#SBATCH --time=24:00:00
#SBATCH --output=slurm_bnn_ol_%j.out
#SBATCH --error=slurm_bnn_ol_%j.err

# ============================================================================
# 업데이트된 BNN-OL 100회 최적화 실험
# ============================================================================
# 변경 사항:
...
LOG_DIR="logs_bnn_ol_100runs_${TIMESTAMP}"
mkdir -p $LOG_DIR

echo "=============================================="
echo "Updated BNN-OL 100 Runs Experiment"
...
============================================
Updated BNN-OL Experiment Configuration
============================================
Timestamp: ${TIMESTAMP}
SLURM Job ID: ${SLURM_JOB_ID}

Model: BNN-OL (Bayesian Neural Network with Online Learning)
Runs: 100
Cost Budget: 50
...
# BNN-OL 100회 실행 (실시간 로그 출력)
echo "[Starting] Updated BNN-OL 100 runs..."
...
stdbuf -oL -eL python -u main.py \
    ...
    2>&1 | stdbuf -oL tee ${LOG_DIR}/bnn_ol_100runs.log

echo ""
echo "=============================================="
echo "Experiment completed!"
echo "Results saved to: ${LOG_DIR}/bnn_ol_100runs.csv"
echo "Log saved to: ${LOG_DIR}/bnn_ol_100runs.log"
echo "=============================================="
