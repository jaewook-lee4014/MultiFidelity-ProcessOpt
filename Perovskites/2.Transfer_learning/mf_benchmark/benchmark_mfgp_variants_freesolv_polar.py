...
def main():
    ...
    output_dir = Path(f'mfgp_variants_freesolv_polar_{timestamp}')
    ...
    # Benchmark configurations - FreeSolv and Polarizability ONLY
    bench_configs = {
        'FreeSolv': {
    ...
    print(f"\nCombinations: {total_combinations} (2 benchmarks × 6 MFGP variants)", flush=True)
